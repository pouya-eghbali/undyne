  ...
  _createClass(Undyne, [{
    ...
    value: function paste() {
      ...
      navigator.clipboard.readText().then(function (text) {
        return _this3.insertAtCaret(text);
      });
    }
  }, {
    key: "delete",
    ...
    key: "insertAtCaret",
    value: function insertAtCaret(key) {
      ...
      if (key == "Enter") {
        ...
        this.content = [].concat(_toConsumableArray(pre), [left + key + right], _toConsumableArray(post)).join("\n");
        this.moveCaret(1, 0);
      }
    ...
    value: function render() {
      ...
      var tokenLinesToDraw = visibleTokenLines.map(function (line) {
        ...
        while (true) {
          ...
          if (removed + token.content.length < _this4.scrollLeft) {
            removed += token.content.length;
            continue;
          }

          line.unshift(_objectSpread({}, token, {
            content: token.content.slice(_this4.scrollLeft - removed)
          }));
          break;
        }
      ...
      tokenLinesToDraw.forEach(function (line, index) {
        ...
        var offsetX = 0;
        _this4.ctx.font = "".concat(_this4.fontSize, "px ").concat(_this4.fontFamily);
        _this4.ctx.fillStyle = _this4.foreground;

        _this4.ctx.fillText(formattedLineNumber, offsetX * _this4.charWidth, _this4.lineHeight * index + _this4.lineHeight);
        ...
        try {
          for (var _iterator = line[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            _this4.ctx.font = "".concat(_this4.fontSize, "px ").concat(_this4.fontFamily);
            _this4.ctx.fillStyle = color || _this4.foreground;

            _this4.ctx.fillText(content, offsetX * _this4.charWidth, _this4.lineHeight * index + _this4.lineHeight);
...
var PrismUndyne = /*#__PURE__*/function (_Undyne) {
  ...
  function PrismUndyne() {
    _classCallCheck(this, PrismUndyne);

    return _possibleConstructorReturn(this, _getPrototypeOf(PrismUndyne).apply(this, arguments));
  }
      ...
      var convertToken = function convertToken(token) {
        if (token.content) {
          if (!_this.colorMap[token.type]) {
            ...
            el.remove();
            _this.colorMap[token.type] = color;
          }

          return {
            content: token.content,
            color: _this.colorMap[token.type]
          };
        }
